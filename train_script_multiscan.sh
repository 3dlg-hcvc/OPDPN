...
#SBATCH --output=/scratch/hanxiao/proj-motionnet/pc_output/multiscan/%x_%j.out
...
echo 'Job Start'
python $PROJ_DIR/train.py --category_number 1 --train_path /home/hanxiao/projects/rrg-msavva/hanxiao/proj-motionnet/Dataset/dataset_multiscan/train.h5 --test_path /home/hanxiao/projects/rrg-msavva/hanxiao/proj-motionnet/Dataset/dataset_multiscan/val.h5 --output_dir /scratch/hanxiao/proj-motionnet/pc_output/multiscan